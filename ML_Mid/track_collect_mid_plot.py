...
histo_sig = np.genfromtxt("histo_sig_collector_mid_rev.csv", delimiter=',')
histo_bg = np.genfromtxt("histo_bg_collector_mid_rev.csv", delimiter=',')
bino = np.genfromtxt("bin_collector_mid_rev.csv", delimiter=',')
...
fig.savefig('mid_variables_rev.png')
